...
interface MathPracticeConfigPopupProps {
  isOpen: boolean;
  onClose: () => void;
  onStartPractice: (config: MathPracticeConfig) => void;
}

interface MathPracticeConfig {
  difficulties: string[];
  domains: string[];
  skills: string[];
  statusFilter: string;
...
export function MathPracticeConfigPopup({
  isOpen,
  onClose,
  onStartPractice,
  ...
  const toggleDomain = (domain: string) => {
    const domainSkillList = mathDomainSkills[domain] || [];
